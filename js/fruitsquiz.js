$(document).ready(function() {
    var images = ["images/df.jpg", "images/papaya.jpg", "images/cherry.jpeg", "images/bb.jpg", "images/veg.jpg", "images/berries.jpg", "images/pineapples.jpeg", "images/peach.jpg"];
    var setOfQns = [{
    ...
    $('#cancel').click(function() {
        if (window.confirm("Are you sure you want to end the quiz? You will be redirect to the main page after selecting OK.")) {
    ...
    function showQn() {
        individualQuestion = setOfQns[currentIndex];
